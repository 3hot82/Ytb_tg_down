...
- Мультиязычность: поддержка интерфейса на русском и английском (RU/EN) через команду `/lang`.
- Обязательная подписка (ОП): проверка подписки на каналы спонсоров перед скачиванием через `SubscriptionMiddleware`.
- Админ-панель: команда `/admin` с интерактивным управлением каналами ОП, статистикой пользователей и безопасной рассылкой (Broadcast).
