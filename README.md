...
Также можно отправить ссылку на профиль Instagram:

```text
https://www.instagram.com/username
```

Ссылки на профиль бот трактует как запрос активных stories этого пользователя. Он не скачивает весь профиль/все посты, чтобы случайно не запустить массовую загрузку.
